...
if( isset( $_GET['username'] ) AND $_GET['username'] != '' ):
	...
	$consumerkey = "D9tsWPIuGCAWWV2VQGn11e9bH";
	$consumersecret = "nzncdCvx27Qvgr9RohjvFl2BClpqTSaIptPiy8B6PC0XYD1o9E";
	$accesstoken = "3174084287-Ggs9cS08ZkizDLB0YLx1EbGMDYjH7K6oHV9FKYV";
	$accesstokensecret = "svrKS7UCfPXHHNDpDFOf4HNwYripbusmygVBRKWSDkrms";
